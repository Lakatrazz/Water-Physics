...
namespace WaterPhysics
{
    ...
    public class WaterVolume : MonoBehaviour
    {
        ...
        [Min(0f)]
        [Tooltip("The size of each quad in the volume.")]
        public float quadSegmentSize = 1f;

        [Header("Fluid")]
        [Min(0f)]
        [Tooltip("The fluid density.")]
        public float density = 1f;

        [Min(0f)]
        [Tooltip("The base drag of the fluid.")]
        public float drag = 1f;

        [Min(0f)]
        [Tooltip("The base angular drag of the fluid.")]
        ...
        {
            if (other.attachedRigidbody && !other.isTrigger && !other.attachedRigidbody.isKinematic && !other.attachedRigidbody.GetComponent<BuoyantBody>()) {
                other.attachedRigidbody.gameObject.AddComponent<BuoyantBody>();
            }
        }
    }
}